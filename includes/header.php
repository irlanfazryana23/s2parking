                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="admin-profile.php"><i class="fa fa- user"></i>Profil Saya</a>

                            <a class="nav-link" href="change-password.php"><i class="fa fa -cog"></i>Ganti Password</a>

                            <a class="nav-link" href="index.php"><i class="fa fa-power -off"></i>Keluar</a>
                        </div>
                    </div>
