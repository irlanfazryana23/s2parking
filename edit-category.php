...
<head>
    ...
    <title>S2Parking - Perbarui Kategori</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Perbarui </strong> Kategori
                            </div>
...
?>              
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="catename" name="catename" class="form-control" placeholder="Kategori Kendaraan" required="true" value="<?php  echo $row['VehicleCat'];?>"></div>
                                    </div>
                                 
                                    <?php } ?>
                                    
                                   <p style="text-align: center;"> <button type="submit" class="btn btn-primary btn-sm" name="submit" >Perbarui</button></p>
                                </form>
                            </div>
