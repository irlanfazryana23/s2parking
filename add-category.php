...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
    $msg="Kategori Berhasil Dimasukan.";
  }
  else
    {
...
<head>
    ...
    <title>S2 Parking - Tambah Kategori</title>
   ...
   <?php include_once('includes/header.php');?>
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="catename" name="catename" class="form-control" placeholder="Kategori Kendaraan" required="true"></div>
                                    </div>
