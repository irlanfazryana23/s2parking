...
if (strlen($_SESSION['vpmsaid']==0)) {
  ...
  $mobno=$_POST['contactnumber'];
    ...
    if ($query) {
    $msg="Profil Admin Berhasil Di Update.";
  }
  else
    {
...
<head>
    ...
    <title>S2Parking - Profil Admin</title>
...
?>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="password-input" class=" form-control-label">Nomor Kontak</label></div>
