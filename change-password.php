...
<head>
    ...
    <title>S2Parking - Ganti Password</title>
...
?>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password Saat Ini</label></div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="password-input" class=" form-control-label">Konfirmasi Password</label></div>
                                    ...
                                    <?php } ?>
                                   <p style="text-align: center;"> <button type="submit" class="btn btn-primary btn-sm" name="submit" >Ganti</button></p>
                                </form>
                            </div>
